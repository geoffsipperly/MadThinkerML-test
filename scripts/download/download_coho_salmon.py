"""
Coho Salmon Image Downloader
================================
Downloads research-grade, openly licensed photos of Coho Salmon
(Oncorhynchus kisutch) from iNaturalist for ML training datasets.

Usage:
    pip install requests
    python download_coho_salmon.py
"""
...
OUTPUT_DIR = Path("coho_salmon_images")
...
def main():
    ...
    print(f"🐟 Coho Salmon Image Downloader")
