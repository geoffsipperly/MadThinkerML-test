"""
Sockeye Salmon Image Downloader
================================
Downloads research-grade, openly licensed photos of Sockeye Salmon
(Oncorhynchus nerka) from iNaturalist for ML training datasets.

Usage:
    pip install requests
    python download_sockeye_salmon.py
"""
...
OUTPUT_DIR = Path("sockeye_salmon_images")
...
def main():
    ...
    print(f"🐟 Sockeye Salmon Image Downloader")
