"""
Chinook Salmon Image Downloader
================================
Downloads research-grade, openly licensed photos of Chinook Salmon
(Oncorhynchus tshawytscha) from iNaturalist for ML training datasets.

Usage:
    pip install requests
    python download_chinook_salmon.py
"""
...
# ──────────────────────────── CONFIG ────────────────────────────
OUTPUT_DIR = Path("chinook_salmon_images")
...
def main():
    ...
    print(f"🐟 Chinook Salmon Image Downloader")
