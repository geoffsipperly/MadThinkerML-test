"""
Atlantic Salmon Image Downloader
================================
Downloads research-grade, openly licensed photos of Atlantic Salmon
(Salmo salar) from iNaturalist for ML training datasets.

Usage:
    pip install requests
    python download_atlantic_salmon.py
"""
...
OUTPUT_DIR = Path("atlantic_salmon_images")
...
def main():
    ...
    print(f"🐟 Atlantic Salmon Image Downloader")
