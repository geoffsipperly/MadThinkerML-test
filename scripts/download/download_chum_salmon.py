"""
Chum Salmon Image Downloader
================================
Downloads research-grade, openly licensed photos of Chum Salmon
(Oncorhynchus keta) from iNaturalist for ML training datasets.

Usage:
    pip install requests
    python download_chum_salmon.py
"""
...
OUTPUT_DIR = Path("chum_salmon_images")
...
def main():
    ...
    print(f"🐟 Chum Salmon Image Downloader")
