"""Train ViT-Tiny sex classifier on fish_sex ImageFolder dataset."""
...
DATA_ROOT = Path("data/fish_sex")
CHECKPOINT_PATH = Path("models/vit_fish_sex.pt")
...
def get_dataloaders(root: Path):
    ...
    assert train_ds.classes == CLASSES, f"Expected {CLASSES}, got {train_ds.classes}"
